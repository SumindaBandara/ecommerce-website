...
function ProductCard(props) {
  ...
  return (
    <div className="h-[1000] relative mt-4 ">
      {isLiked ? (
        <Heart
      ...
      <div className="mt-4">
        ...
        <Link to={`/shop/${props.selected_id}`}>
        <div className="mt-2">
          <button
            onClick={handleProductClick}
            type="button"
            className="border-2 border-red-300 px-4 py-1 text-lg rounded-lg mt-2 font-medium hover:bg-black hover:text-white transition"
          >
            View Details
          </button>
        </div>
